                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="tipe_paket" type="text" class="form-control input-rounded" placeholder="tipe paket" value="<?= set_value('tipe_paket') ?>">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <!-- text input -->
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>Nama vendor vendor</label>
                                <select name="deskripsi[]" class="bootstrap-select" id="select2" data-live-search="true" multiple="multiple">
                                    <?php foreach ($dekor as $key => $value) { ?>
                                        <option value="<?= $value->id_detail ?>"><?= $value->nama ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>-->
