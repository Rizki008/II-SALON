        ...
        <div class="row">
            ...
            <h5><i class="icon fa fa-exclamation-triangle"></i>', '</h5></div>');
                ...
                <h5><i class="icon fas fa-exclamation-triangle"></i>' . $error_upload . '</h5></div>';
                        ...
                        echo form_open_multipart('foto/add/' . $paket->id_paket) ?>
                        ...
                        <div class="form-group">
                            ...
                            <a href="<?= base_url('foto') ?>" class="btn btn-warning btn-sm">Kembali</a>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <a href="<?= base_url('foto/delete/' . $value->id_paket . '/' . $value->id_gambar) ?> " class="btn btn-primary">Delete</a>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
